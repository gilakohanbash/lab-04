...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("gkohanba/ipinfo")
    client.subscribe("gkohanba/dateInfo")
    client.subscribe("gkohanba/timeInfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("gkohanba/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("gkohanba/dateInfo", on_message_from_dateInfo)
    client.message_callback_add("gkohanba/timeInfo", on_message_from_timeInfo)
